...
export default function PartnerClientLayout({ children }: { children: React.ReactNode }) {
    ...
    if (hideLayout) {
        return <div className={`min-h-screen w-full ${plusJakartaSans.className}`}>{children}</div>
    }
            ...
            >
                ...
                <div className="h-20 flex items-center px-6 border-b border-slate-200 bg-white justify-between">
                    <div className="flex items-center">
                        ...
                        <span className="text-xl font-black text-slate-800 tracking-tight">Partner Panel</span>
                    </div>
                ...
                <div className="p-4 border-t border-slate-200 bg-white">
                    <Link href="/" className="flex items-center px-4 py-3 rounded-xl text-slate-600 hover:bg-slate-50 hover:text-[#E31E24] transition-all mb-2 group">
                        <Home className="w-5 h-5 mr-3.5 text-slate-500 group-hover:text-[#E31E24]" />
            ...
            <div className={`flex-1 flex flex-col min-h-screen overflow-hidden transition-all duration-300 ${isSidebarOpen ? 'xl:pl-72' : ''}`}>
                ...
                <header className="h-16 bg-white border-b border-slate-200 flex items-center px-4 justify-between z-30 sticky top-0">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-base sm:text-lg font-bold text-slate-900">Partner Panel</span>
                    </div>
