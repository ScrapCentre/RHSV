...
export default async function PersonalChatPage({ params }: ChatPageProps) {
    // 1. Authorize Personal Partner
            ...
            >
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        <h1 className="text-lg sm:text-xl font-black text-white tracking-tight truncate">Real-time Negotiation Desk</h1>
                        <p className="text-[11px] text-red-200 mt-0.5 hidden sm:block">Direct messaging & instant price negotiation with the customer.</p>
                    </div>
                </div>
            </div>

            {/* Chat Desk Container */}
            <ChatContainer role="partner" threadId={threadId} />
        </div>
    )
}
