...
export default function ManualLeadsAdminPage() {
                    ...
                    {showForm && (
                        ...
                        >
                            <div className="bg-white dark:bg-[#0E192D] rounded-[2rem] p-6 sm:p-8 shadow-sm border border-slate-100 dark:border-slate-800/80 space-y-6">
                                ...
                                {formError && (
                                    <div className="flex items-center gap-2 px-4 py-3 rounded-xl bg-red-50 border border-red-200 text-red-700 text-xs font-semibold dark:bg-red-900/20 dark:border-red-800 dark:text-red-400">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <a 
                                                ...
                                                className="px-4 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-350 rounded-xl flex items-center justify-center transition-all"
