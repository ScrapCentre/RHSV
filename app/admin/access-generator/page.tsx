                                    ...
                                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                        {filteredB2b.map(partner => (
                                            <tr key={partner._id} className="hover:bg-slate-50/30 dark:hover:bg-slate-850/10">
                                                ...
                                                <td className="px-5 py-3.5 font-semibold text-slate-600 dark:text-slate-350">{partner.email}</td>
                                    ...
                                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                        {filteredExecs.map(exec => (
                                            <tr key={exec._id} className="hover:bg-slate-50/30 dark:hover:bg-slate-850/10">
                                                <td className="px-5 py-3.5 font-mono text-slate-400 select-all">{exec._id}</td>
                                                ...
                                                <td className="px-5 py-3.5 text-slate-450 dark:text-slate-400">{new Date(exec.createdAt).toLocaleDateString()}</td>
                                                <td className="px-5 py-3.5 text-center">
                                                    <button 
