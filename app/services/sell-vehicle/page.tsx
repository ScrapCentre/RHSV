...
import { Zap, Truck, CreditCard, Shield } from "lucide-react"
  ...
  const benefits = [
    {
      ...
      description: "Get real-time price based on market value",
    },
    {
      icon: Truck,
      title: "Doorstep Pickup",
      description: "Convenient free pickup from your location",
    },
    {
      icon: CreditCard,
    ...
    },
    {
      ...
      description: "100% legal and transparent documentation",
    },
  ]
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto px-4 py-12">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-8 text-white leading-[1.1] drop-shadow-sm">
                Sell Your <span className="text-emerald-400">Old Vehicle</span>
              </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-emerald-800 text-lg leading-relaxed font-medium">Experience a hassle-free selling process with complete transparency and top-tier support.</p>
              </div>
